...
class WorkingThread3(QThread):
    ...
    def run(self):
        ...
        Capture = cv2.VideoCapture("C:\\Users\\AAA\Desktop\\others\\FYP\\FYP WORK -threading\\FYP FEB 2022\\yoloModelData\\video1.mp4")
